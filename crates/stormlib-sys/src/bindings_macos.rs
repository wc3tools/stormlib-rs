...
pub const STORMLIB_VERSION_STRING: &[u8; 5usize] = b"9.23\0";
...
pub const LISTFILE_NAME: &[u8; 11usize] = b"(listfile)\0";
pub const SIGNATURE_NAME: &[u8; 12usize] = b"(signature)\0";
pub const ATTRIBUTES_NAME: &[u8; 13usize] = b"(attributes)\0";
pub const PATCH_METADATA_NAME: &[u8; 17usize] = b"(patch_metadata)\0";
